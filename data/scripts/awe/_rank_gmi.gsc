...
InitializeBattleRank()
{
	...
	if(!isdefined(game["br_points_objective"]))	// Achieving an objective
		game["br_points_objective"] = maps\mp\gametypes\_awe::cvardef("awe_br_points_objective",5,-999,999,"int");
	if(!isdefined(game["br_points_teamcap"]))	// How many points to the team
		game["br_points_teamcap"] = maps\mp\gametypes\_awe::cvardef("awe_br_points_teamcap",1,-999,999,"int");
	if(!isdefined(game["br_points_cap"]))		// Capping a flag
		game["br_points_cap"] = maps\mp\gametypes\_awe::cvardef("awe_br_points_cap",2,-999,999,"int");
	if(!isdefined(game["br_points_assist"]))	// Assisting a cap
		game["br_points_assist"] = maps\mp\gametypes\_awe::cvardef("awe_br_points_assist",1,-999,999,"int");
	if(!isdefined(game["br_points_defense"]))	// Killing enemy in flag zone
		game["br_points_defense"] = maps\mp\gametypes\_awe::cvardef("awe_br_points_defense",2,-999,999,"int");
	if(!isdefined(game["br_points_kill"]))		// Getting a kill
		game["br_points_kill"] = maps\mp\gametypes\_awe::cvardef("awe_br_points_kill",1,-999,999,"int");
	if(!isdefined(game["br_points_teamkill"]))	// Killing someone on your own team
		game["br_points_teamkill"] = maps\mp\gametypes\_awe::cvardef("awe_br_points_teamkill",-3,-999,999,"int");
	if(!isdefined(game["br_points_suicide"]))	// Killing yourself
		game["br_points_suicide"] = maps\mp\gametypes\_awe::cvardef("awe_br_points_suicide",-1,-999,999,"int");
	if(!isdefined(game["br_points_dying"]))		// Getting killed
		game["br_points_dying"] = maps\mp\gametypes\_awe::cvardef("awe_br_points_dying",0,-999,999,"int");
	if(!isdefined(game["br_points_reversal"]))	// Other team taking a flag
		game["br_points_reversal"] = maps\mp\gametypes\_awe::cvardef("awe_br_points_reversal",0,-999,999,"int");
...
////////// Changed by AWE /////////////
	...
	if(!isdefined(game["br_rank_1"]))	// points to achieve first rank
		game["br_rank_1"] = maps\mp\gametypes\_awe::cvardef("awe_br1",10,0,999,"int");
	if(!isdefined(game["br_rank_2"]))	// points to achieve second rank
		game["br_rank_2"] = maps\mp\gametypes\_awe::cvardef("awe_br2",20,0,999,"int");
	if(!isdefined(game["br_rank_3"]))	// points to achieve third rank
		game["br_rank_3"] = maps\mp\gametypes\_awe::cvardef("awe_br3",30,0,999,"int");
	if(!isdefined(game["br_rank_4"]))	// points to achieve fourth rank
		game["br_rank_4"] = maps\mp\gametypes\_awe::cvardef("awe_br4",40,0,999,"int");
		
	// set up the ammo values for the various ranks
	// remember that they will already have one clip in the gun
	game["br_ammo_gunclips_0"] = maps\mp\gametypes\_awe::cvardef("awe_br0_gunclips",4,1,999,"int");
	game["br_ammo_gunclips_1"] = maps\mp\gametypes\_awe::cvardef("awe_br1_gunclips",4,1,999,"int");
	game["br_ammo_gunclips_2"] = maps\mp\gametypes\_awe::cvardef("awe_br2_gunclips",5,1,999,"int");
	game["br_ammo_gunclips_3"] = maps\mp\gametypes\_awe::cvardef("awe_br3_gunclips",5,1,999,"int");
	game["br_ammo_gunclips_4"] = maps\mp\gametypes\_awe::cvardef("awe_br4_gunclips",6,1,999,"int");

	game["br_ammo_pistolclips_0"] = maps\mp\gametypes\_awe::cvardef("awe_br0_pistolclips",2,0,999,"int");
	game["br_ammo_pistolclips_1"] = maps\mp\gametypes\_awe::cvardef("awe_br1_pistolclips",3,0,999,"int");
	game["br_ammo_pistolclips_2"] = maps\mp\gametypes\_awe::cvardef("awe_br2_pistolclips",3,0,999,"int");
	game["br_ammo_pistolclips_3"] = maps\mp\gametypes\_awe::cvardef("awe_br3_pistolclips",4,0,999,"int");
	game["br_ammo_pistolclips_4"] = maps\mp\gametypes\_awe::cvardef("awe_br4_pistolclips",4,0,999,"int");

	game["br_ammo_grenades_0"] = maps\mp\gametypes\_awe::cvardef("awe_br0_grenades",1,0,999,"int");
	game["br_ammo_grenades_1"] = maps\mp\gametypes\_awe::cvardef("awe_br1_grenades",2,0,999,"int");
	game["br_ammo_grenades_2"] = maps\mp\gametypes\_awe::cvardef("awe_br2_grenades",2,0,999,"int");
	game["br_ammo_grenades_3"] = maps\mp\gametypes\_awe::cvardef("awe_br3_grenades",2,0,999,"int");
	game["br_ammo_grenades_4"] = maps\mp\gametypes\_awe::cvardef("awe_br4_grenades",3,0,999,"int");

	game["br_ammo_smoke_grenades_0"] = maps\mp\gametypes\_awe::cvardef("awe_br0_smokegrenades",1,0,999,"int");
	game["br_ammo_smoke_grenades_1"] = maps\mp\gametypes\_awe::cvardef("awe_br1_smokegrenades",1,0,999,"int");
	game["br_ammo_smoke_grenades_2"] = maps\mp\gametypes\_awe::cvardef("awe_br2_smokegrenades",2,0,999,"int");
	game["br_ammo_smoke_grenades_3"] = maps\mp\gametypes\_awe::cvardef("awe_br3_smokegrenades",2,0,999,"int");
	game["br_ammo_smoke_grenades_4"] = maps\mp\gametypes\_awe::cvardef("awe_br4_smokegrenades",2,0,999,"int");
	
	game["br_ammo_satchel_charge_0"] = maps\mp\gametypes\_awe::cvardef("awe_br0_satchelcharge",0,0,999,"int");
	game["br_ammo_satchel_charge_1"] = maps\mp\gametypes\_awe::cvardef("awe_br1_satchelcharge",0,0,999,"int");
	game["br_ammo_satchel_charge_2"] = maps\mp\gametypes\_awe::cvardef("awe_br2_satchelcharge",0,0,999,"int");
	game["br_ammo_satchel_charge_3"] = maps\mp\gametypes\_awe::cvardef("awe_br3_satchelcharge",1,0,999,"int");
	game["br_ammo_satchel_charge_4"] = maps\mp\gametypes\_awe::cvardef("awe_br4_satchelcharge",1,0,999,"int");
///////////////////////////////////////////
