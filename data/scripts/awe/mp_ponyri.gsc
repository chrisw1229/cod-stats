...
cull_entities()
{
	...
	switch(gametype)
	{
		...
		case "lts":  cullflag = 256; break;
		case "sd":  cullflag = 256; break;
		case "rsd":  cullflag = 256; break;
		case "dem":  cullflag = 256; break;
		case "re":   cullflag = 256; break; // not supported
		case "mc_ctf": cullflag = 256; break;
		case "mc_lts":  cullflag = 256; break;
		case "mc_sd":  cullflag = 256; break;
		case "mc_rsd":  cullflag = 256; break;
		case "mc_dem":  cullflag = 256; break;
		case "mc_re":   cullflag = 256; break; // not supported
		
		// !Medium
		// command point-style modes (i.e. Domination)
		case "dom": cullflag = 512; break;
		case "mc_dom": cullflag = 512; break;
		
		// !Hard
		// open dm-style spawning
		case "dm":  cullflag = 1024; break;
		case "tdm": cullflag = 1024; break;
		case "actf": cullflag = 1024; break;
		case "hq":  cullflag = 1024; break;
		case "bel": cullflag = 1024; break;
		case "ttdm": cullflag = 1024; break; // not supported
		case "mc_dm":  cullflag = 1024; break;
		case "mc_tdm": cullflag = 1024; break;
		case "mc_actf": cullflag = 1024; break;
		case "mc_hq":  cullflag = 1024; break;
		case "mc_bel": cullflag = 1024; break;
		case "mc_ttdm": cullflag = 1024; break; // not supported

		// !Deathmatch
		// numerous localized team spawns (i.e. Base Assault)
		case "bas": cullflag = 2048; break;
		case "mc_bas": cullflag = 2048; break;
